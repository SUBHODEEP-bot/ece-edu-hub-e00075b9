  ...
  return (
    <>
      ...
      <Button
        ...
        className="fixed bottom-6 right-4 h-14 w-14 rounded-full shadow-gold gradient-gold hover:shadow-glow-hover transition-smooth z-50"
        size="icon"
      >
        {isOpen ? (
      ...
      {/* Chat Window */}
      {isOpen && (
        <Card className="fixed bottom-24 right-4 w-[90vw] sm:w-96 h-[500px] shadow-xl border-2 border-gold/30 z-50 flex flex-col">
