    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-28 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl text-center relative z-10">
          <Card className="p-8 md:p-16 rounded-3xl md:rounded-[3rem] shadow-gold border-2 border-gold/30 animate-scale-in relative overflow-hidden group bg-gradient-to-br from-white via-gold/5 to-white">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center justify-center w-16 h-16 md:w-24 md:h-24 gradient-gold rounded-2xl md:rounded-[2rem] mb-6 md:mb-8 shadow-gold group-hover:scale-110 group-hover:shadow-glow transition-all duration-500 relative">
                <Users className="w-8 h-8 md:w-12 md:h-12 text-navy" />
                <div className="absolute inset-0 gradient-gold rounded-2xl md:rounded-[2rem] blur-2xl opacity-50"></div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center px-4">
                <Link to="/register" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full sm:w-auto gradient-gold text-navy hover:shadow-gold font-bold px-10 py-5 md:px-12 md:py-7 text-base md:text-lg rounded-2xl group transition-smooth relative overflow-hidden border-2 border-gold/20">
                    <span className="relative z-10 flex items-center justify-center font-bold">
                      Create Free Account
                      <ArrowRight className="ml-2 w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-2 transition-transform" />
                    </span>
                ...
                <Link to="/login" className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-navy text-navy hover:bg-navy hover:text-white font-bold px-10 py-5 md:px-12 md:py-7 text-base md:text-lg rounded-2xl transition-smooth">
                    Sign In
                  </Button>
                </Link>
              </div>
              ...
              {/* Trust Badges */}
              <div className="mt-8 md:mt-12 flex flex-wrap justify-center gap-4 md:gap-8 text-xs md:text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-gold" />
